	...
	<div id="page-wrapper">
		...
		<div id="main" class="wrapper style1">
			<div class="container">
				...
				<!-- Form -->
				<section>
					<form method="post" action="/Woosuk/controller/Write_board"
						...
						<div class="row gtr-uniform gtr-50">
							...
							<div class="col-12">
								<textarea name="contents" id="contents" placeholder="내용을 입력하세요"
									rows="6"></textarea>
							...
							<div class="col-12">
								<ul class="actions">
									...
									<li></li>
									<li></li>
									<li><input id="save_btn" type="submit" value="저장"
										class="primary" /></li>
						...
						function() {
							...
							contents.addEventListener("keyup", function() {
								if (contents.value == ""
									...
									setErrorMessage("contents_error",
											"내용을 작성해주세요.");
								} else {
